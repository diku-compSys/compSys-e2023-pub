...
|      | 05 Sep | Basic | Troels   | Assembly code and machine model                                               | COD 2.1-2.4,2.6-2.7, JG 4 |
| 37   | 11 Sep | Basic | Troels   | Functions and text                                                            | COD 2.8-2.9, JG 5-7 |
|      | 13 Sep | Basic | Troels   | Computer arithmetic                                                           | COD 3.1-3.3, 3.5 |
| 38   | 18 Sep | Basic | Troels   | C Programming - pointers and memory                                           | JG 8-9, 11 |
|      | 20 Sep | Basic | Troels   | C Programming - dynamic memory                                                | JG 12-13 |
|      |        |       |          | Hand-in A0 -- RISC-V programming                                              |          |
| 39   | 25 Sep | Basic | Troels   | Memory hierarchy and caching                                                  | COD 5.1-5.4 |
|      | 27 Sep | OS    | Troels   | Intro to Operating systems - kernel, processes, system calls                  | OSTEP 2,4,5 |
| 40   | 02 Oct | OS    | Troels   | Virtual memory - hardware perspective                                         | COD 5.7-5.8 |
|      | 04 Oct | OS    | Troels   | Virtual memory - OS perspective                                               | OSTEP 13,17 |
|      |        |       |          | Hand-in A1 -- dynamic allocation + caching                                    |          |
| 41   | 09 Oct | OS    | Troels   | Concurrency I                                                                 | COD 6.1-6.2, 6.4-6.5 and OSTEP 27 |
|      | 11 Oct | OS    | Troels   | Concurrency II                                                                | OSTEP 29,30 |
...
|      | 22 Nov | CN    | David    | Security Across the Network                                                   | KR 8.1 - 8.7 |
| 48   | 27 Nov | Arc   | Finn     | Digital logic                                                                 | COD A.1 - A.3, A.5, A7 - A.9 |
|      | 29 Nov | Arc   | Finn     | En simpel maskine                                                             | COD 4.1 - 4.4 |
|      |        |       |          | Hand-in A4 -- Threaded Server/application, multi-threaded performance         |  |
| 49   | 04 Dec | Arc   | Finn     | A5 - Simulation af en maskine                                                 | RISCV 2.2 - 2.6 + 6 [RISCV](https://riscv.org/wp-content/uploads/2017/05/riscv-spec-v2.2.pdf) og lille note om afkodning |
...
| 51   | 18 Dec | Arc   | Finn     | Shared memory multithreading og A6                                            | COD 6.1, 6.5, 5.10, 5.14, 2.11 |
|      | 20 Dec |       |          | Christmas lecture by Mads Ynddal and Pankaj Raghav fra Samsung's Global Open Source Team                                    |         |
...
| 2    | 10 Jan | CN    | Michael  |                                                                               | KR 5.1 - 5.3, KR 6.1 - 6.4.3, KR 8.5 - 8.6 |
